                ...
                <table width="" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000; padding: 5px 5px 5px 0px;">
                            <?php echo $this->course->rating_bar($course, "overall_recommendation", 0, 1, 1, "large", "green"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" style="padding: 5px 0px 5px;">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000; padding: 5px 5px 5px 0px;">
                            <?php echo $this->course->rating_bar($course, "overall_recommendation", 0, 1, 0, "large", "red"); ?>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "textbook_rating", 0, 4, 4, "small", "blue"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "textbook_rating", 0, 4, 3, "small", "green"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "textbook_rating", 0, 4, 2, "small", "yellow"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "textbook_rating", 0, 4, 1, "small", "red"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "textbook_rating", 0, 4, 0, "small", "white"); ?>
                        </td>
                    </tr>
                </table>
            </td>
            <td align="right" valign="top">
                ...
                <table width="" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "attendance_rating", 1, 4, 4, "small", "blue"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "attendance_rating", 1, 4, 3, "small", "green"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "attendance_rating", 1, 4, 2, "small", "yellow"); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" valign="center" style="border-left: 1px solid #000;">
                            <?php echo $this->course->rating_bar($course, "attendance_rating", 1, 4, 1, "small", "red"); ?>
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <div style="font-size: 11px; margin: 8px 0; line-height: 14px;">
                                    Taken with:
                                    <br/>
                                    <a href="<?php echo site_url()."professor.php?id=".$professor['id']; ?>"><?php echo $professor['first_name']." ".$professor['last_name']; ?></a>
                                </div>
                            </td>
                        </tr>
